                ...
                <form action="{{ route('contact.update', ['contact' => $contact->id]) }}" method="POST">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-12">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Your email" required value="{{ $contact->email }}">
                        </div>

                        <div class="col-md-12 ">
                            <label for="instagram" class="form-label">Instagram</label>
                            <input type="text" class="form-control" name="instagram" placeholder="Your instagram" required value="{{ $contact->instagram }}">
                        </div>

                        <div class="col-md-12">
                            <label for="facebook" class="form-label">Facebook</label>
                            <input type="text" class="form-control" name="facebook" placeholder="Your facebook" required value="{{ $contact->facebook }}">
                        </div>
