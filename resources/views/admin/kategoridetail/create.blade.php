...
<main id="main" class="main">
    ...
    <section class="section contact">
        <div class="card p-4">
            <form method="POST" action="{{ route('kategoridetail.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="video1" name="video1">
                </div>
                <div class="mb-3">
                    <label for="video2" class="form-label">Link Video2</label>
                    <input type="text" class="form-control" id="video2" name="video2">
                </div>
                <div class="mb-3">
                    <label for="video3" class="form-label">Link Video3</label>
                    <input type="text" class="form-control" id="video3" name="video3">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" style="height: 80px"></textarea>
                </div>
                @if ($errors->any())
